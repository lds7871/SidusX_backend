...
public class IpWhitelistInterceptor implements HandlerInterceptor {
    ...
    private static final Logger log = LoggerFactory.getLogger(IpWhitelistInterceptor.class);
    ...
    // Content cache limit for ContentCachingRequestWrapper
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        if (!(request instanceof ContentCachingRequestWrapper)) {
            cachedRequest = new ContentCachingRequestWrapper(request, REQUEST_CACHE_LIMIT);
        }
