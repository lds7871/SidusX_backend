...
public class EmailService {
  ...
  public void sendSimpleMail(String to, String subject, String text) {
    try {
      ...
      logger.error("发送简单邮件失败 - 收件人: {}, 错误信息: {}", to, e.getMessage(), e);
  ...
  public void sendHtmlMail(String to, String subject, String htmlContent) {
    try {
      ...
      logger.error("发送HTML邮件失败 - 收件人: {}, 错误信息: {}", to, e.getMessage(), e);
      throw new RuntimeException("邮件发送失败", e);
    }
  }
  ...
  public void sendMailWithAttachment(String to, String subject, String htmlContent,
    ...
    try {
      ...
      javaMailSender.send(message);
      logger.info("带附件邮件发送成功 - 收件人: {}, 主题: {}", to, subject);
    } catch (MessagingException e) {
      logger.error("发送带附件邮件失败 - 收件人: {}, 错误信息: {}", to, e.getMessage(), e);
      throw new RuntimeException("邮件发送失败", e);
    }
  }
