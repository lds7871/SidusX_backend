...
2. 如有说明为“公开接口”为接口加上注解"@BypassIpWhitelist"。dto引入lombok.Getter与lombok.Setter、io.swagger.annotations内的组件增强阅读性。entity引入lombok、io.swagger.annotations、mybatisplus，数据库查询操作在serverimp内执行。
