...
2. 如有说明为“公开接口”为接口加上注解"@BypassIpWhitelist"。请求与响应都使用Json格式都需要dto且引入lombok.Getter与lombok.Setter、io.swagger.annotations内的组件增强阅读性。entity引入lombok、io.swagger.annotations，数据库查询操作最好在serverimp内执行。
